...
\begin{document}
    ...
    % \end{enumerate}
    % From property 5 and 6, we could see from lemma\TODO{} that 
    ...
    %     \frac{c(d) p - p (d + 1)}{4W} = c(d - 1) p > \abs{V \bigcap S} \forall V \hbox{hyperplane in } \IntegerP{p}^d.
    % \end{equation}
    ...
    \newpage
    \include{chapters/kemnitz}
    \newpage
    \include{chapters/alonDubiner}
\end{document}