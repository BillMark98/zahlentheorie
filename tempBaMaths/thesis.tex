...
this concept and gives some examples in the low-dimensional case. The next chapter deals with the \emph{Kemnitz} conjecture.
...
\newpage
    ...
    \begin{lemma}\label{lem:f_3_2_Value_Harborth}
        ...
        \end{equation*}
    \end{lemma}
    \begin{theorem}[Erd\oUmlaut-Ginsburg-Ziv]\label{lem:Erdos2NM1}
        \begin{equation*}
            \fnd{n}{1} = 2n - 1  
        \end{equation*}
    \end{theorem}  
