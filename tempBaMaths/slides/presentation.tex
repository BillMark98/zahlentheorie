...
\begin{frame}
    ...
    \begin{thm}[\warningTheorem](3.1)\label{thm:warning}
        ...
        Let $p_1,\ldots,p_m$ be $m$ polynomials in $\PolynomialRing{\Field{q}}{n}$, with degree $d_1,\ldots,d_m$. Denote the number of common
...
%------------------------------------------------
\begin{frame}
    \frametitle{Proof of Corollary 3.2(2) $x_{3n-2} = 0$}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{small}
            \begin{align*}
...
%------------------------------------------------
\begin{frame}
    \frametitle{Proof of Corollary 3.2(3) $x_{3n-2} \neq 0$}
    $x_{3n-2} \neq 0$
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{small}
...
\begin{frame}
    \begin{proofs}
        ...
        % We could see that 
        \pause
        Given a subset $Y \subset X, \sothat \abs{Y} = p, \sum_{y\in Y} y \equiv 0$
        \[\abs{\set{I| Y\subset I, \;\abs{I} = 3p-3}}
        = \binom{3p-3}{2p-3},\]
...
\begin{frame}
    \begin{proofc}
        ...
        \begin{align*}
            ...
            &\equiv 3
        \end{align*}        
        Note that we have used the fact that $(-1)^{p-1} \equiv 1$.
    \end{proofc}    
\end{frame}
...
\begin{frame}
    \begin{proofc}
        Now by fixing $B$ and counting the possible set $C$, we get:
