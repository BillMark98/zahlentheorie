...
\begin{prob}\label{prob:centroid}
...
\zeroSumSeq{n}, where $0$ denotes the zero vector
 in $G$. 
\pause
\begin{prob}\label{prob:zeroSumSeq}
    Find the 
    number $f(n,d)$, \sothat 
...
\begin{defn}[via examples]\label{def:multisetOperation}
...
\begin{frame}
    ...
    \begin{lem}\label{lem:f_n_d_naturalBound}
...
\begin{frame}
    \frametitle{Examples}
    \begin{thm}[Erd\oUmlaut s-Ginsburg-Ziv]\label{thm:Erdos2NM1}
        \begin{equation*}
            \fnd{n}{1} = 2n - 1  
        \end{equation*}
    \end{thm}  
...
\begin{frame}
    ...
    \begin{lem}\label{lem:f_nd_2_potent}
        \begin{equation*}
    ...
    % \end{lem}
    \pause
    \begin{lem}\label{lem:f_3Potent_2_value}
        \begin{equation*}
...
\end{columns}
\pause
Collecting all the number of common zeros considered in different cases
            \begin{equation*}
...
%------------------------------------------------
\begin{frame}
    \begin{cor}\label{cor:4pM3_twoEquations}
        If $\abs{X} = 4p-3$, then
        \begin{enumerate}
        ...
        \end{enumerate}
    \end{cor}
    \begin{cor}\label{cor:4pM3_multiSum}
...
%------------------------------------------------
\begin{frame}
    \begin{lem}\label{lem:4pM3_pX0_impliesPM1_3PM1}
...
\begin{frame}
    ...
    \begin{proofs}
        ...
        \end{equation}
        Assume there is a set $X$, with $\abs{X} = 4p-3$ which contradicts the thm, that is $\numSumSubset{p}{X} = 0$.
