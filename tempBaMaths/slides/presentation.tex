...
% ================================
% redefine theorem for frame breaks
...
%------------------------------------------------
\begin{frame}
    \frametitle{Proof of Corollary~\ref{cor:origCountingJ3p}(1) $x_{3n-2} = 0$}
    $x_{3n-2} = 0$\\
\pause
    \begin{columns}
...
%------------------------------------------------
\begin{frame}
    \frametitle{Proof of Corollary~\ref{cor:origCountingJ3p}(2)}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{small}
            \begin{align*}
...
%------------------------------------------------
\begin{frame}
    \frametitle{Proof of Corollary~\ref{cor:origCountingJ3p}(3)}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{small}
            \begin{align*}
